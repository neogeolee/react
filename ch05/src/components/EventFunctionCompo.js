...
const EventFunctionCompo = () => {
    ...
    return (
        <div className="EventFunctionCompo">
            <em>EventFunctionCompo</em>
            {/*onClick 이벤트*/}
            ...
            <h1 style={{color:color2}}
                ...
                onMouseOut={()=>{setColor2("green")}}>마우스 오버, 마우스 아웃 이벤트</h1>
            {/*onChange 이벤트*/}
...
export default EventFunctionCompo;